...
package System.BB.Board_Support is
   ...
   function Tick_Interrupt_ID return Interrupts.Interrupt_ID;
   pragma Inline (Tick_Interrupt_ID);
   --  Return the interrupt level to use for the system tick handler

   procedure Clear_Tick_Interrupt;
   pragma Inline (Clear_Tick_Interrupt);
