...
package body System.BB.Time is
   ...
   procedure Tick_Handler (Interrupt : Interrupts.Interrupt_ID);
   --  Handler for the tick interrupt
   ...
   procedure Tick_Handler (Interrupt : Interrupts.Interrupt_ID) is
   begin
      pragma Unreferenced (Interrupt);

      Board_Support.Clear_Tick_Interrupt;
   ...
   begin
      ...
      Interrupts.Attach_Handler
        (Tick_Handler'Access,
         Tick_Interrupt_ID,
         Priority_Of_Interrupt (Tick_Interrupt_ID));
